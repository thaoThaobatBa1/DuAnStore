...
namespace DAL.Migrations
{
    ...
    [Migration("20241020154556_updateprice")]
            ...
            modelBuilder.Entity("DAL.Entities.AppRoles", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = new Guid("142f313f-41d7-4bc1-abfc-06adcdd636db"),
            ...
            modelBuilder.Entity("DAL.Entities.Brand", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateBy = "ThaiSon",
                            CreatedDate = new DateTime(2024, 10, 20, 22, 45, 55, 568, DateTimeKind.Local).AddTicks(3604),
            ...
            modelBuilder.Entity("DAL.Entities.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateBy = "ThaiSon",
                            CreatedDate = new DateTime(2024, 10, 20, 22, 45, 55, 568, DateTimeKind.Local).AddTicks(3339),
            ...
            modelBuilder.Entity("DAL.Entities.Manufacturer", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("7dbbe905-9926-42ef-9727-7a0b7bd9f1b4"),
                            Country = "America",
                            CreateBy = "ThaiSon",
                            CreatedDate = new DateTime(2024, 10, 20, 22, 45, 55, 568, DateTimeKind.Local).AddTicks(3667),
                            Name = "COCA",
                            UpdateBy = ""
                        });
                });
            ...
            modelBuilder.Entity("DAL.Entities.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("c245ab2a-ba9b-4250-b25f-bc4121320bf1"),
                            BrandId = new Guid("473d4d0b-6e80-423c-a73e-65db3c1fc127"),
                            CreateBy = "ThaiSon",
                            CreatedDate = new DateTime(2024, 10, 20, 22, 45, 55, 568, DateTimeKind.Local).AddTicks(3711),
                            Description = "Nuốc ngọt không đường",
                            ManufactureId = new Guid("7dbbe905-9926-42ef-9727-7a0b7bd9f1b4"),
