...
namespace DAL.Migrations
{
    ...
    [Migration("20241023184757_updateOrder")]
            ...
            modelBuilder.Entity("DAL.Entities.AppRoles", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = new Guid("943eb710-02de-4e89-8df5-326a0f6a958b"),
            ...
            modelBuilder.Entity("DAL.Entities.Brand", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateBy = "ThaiSon",
                            CreatedDate = new DateTime(2024, 10, 24, 1, 47, 55, 399, DateTimeKind.Local).AddTicks(1421),
            ...
            modelBuilder.Entity("DAL.Entities.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateBy = "ThaiSon",
                            CreatedDate = new DateTime(2024, 10, 24, 1, 47, 55, 399, DateTimeKind.Local).AddTicks(1126),
            ...
            modelBuilder.Entity("DAL.Entities.Manufacturer", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("09f59130-08be-44a2-b578-2bc03192ef80"),
                            Country = "America",
                            CreateBy = "ThaiSon",
                            CreatedDate = new DateTime(2024, 10, 24, 1, 47, 55, 399, DateTimeKind.Local).AddTicks(1506),
                            Name = "COCA",
                            UpdateBy = ""
                        });
                });
            ...
            modelBuilder.Entity("DAL.Entities.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("a896c993-059c-49ec-ae1a-1332a96b95dd"),
                            BrandId = new Guid("473d4d0b-6e80-423c-a73e-65db3c1fc127"),
                            CreateBy = "ThaiSon",
                            CreatedDate = new DateTime(2024, 10, 24, 1, 47, 55, 399, DateTimeKind.Local).AddTicks(1560),
                            Description = "Nuốc ngọt không đường",
                            ManufactureId = new Guid("09f59130-08be-44a2-b578-2bc03192ef80"),
